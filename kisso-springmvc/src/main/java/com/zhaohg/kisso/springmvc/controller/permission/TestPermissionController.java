 ...
 * the License.
 */
package com.zhaohg.kisso.springmvc.controller.permission;
...
public class TestPermissionController {
	 ...
	 */
	@Permission("1000")
	@RequestMapping("/test/permission/index")
	 ...
	 */
	@Permission("1001")
	@RequestMapping("/test/permission/userinfo")
	...
	@RequestMapping("/test/permission/illegalAccess")
